...
**Search mode:** `conservative` — preserve identity, subtle improvements, vocal belief

**Mode reach (profile-authored):** favors `vocal_ride`, `depth_cleanup`; suppresses `width_bloom` — capped at `low` risk
...
_Mode fork: suppressed `width_bloom`; favored `vocal_ride`._
